...
export const deleteFile = params => { return instance.post(`/api/MLZone/file/deleteFile.do`, qs.stringify(params)).then(res => res.data); };
...
export const getWebSourceListByParam = params => { return instance.post(`/api/MLZone/webSource/getWebSourceListByParam.do`, qs.stringify(params)).then(res => res.data); };
export const deleteWebSourceById = params => { return instance.post(`/api/MLZone/webSource/deleteWebSourceById.do`, qs.stringify(params)).then(res => res.data); };
export const saveOrUpdateWebSource = params => { return instance2.post(`/api/MLZone/webSource/saveOrUpdateWebSource.do`, JSON.stringify(params)).then(res => res.data); };
